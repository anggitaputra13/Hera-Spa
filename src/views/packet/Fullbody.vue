    ...
    <div class="container">
      ...
      <div class="row mb-4">
        <div
          ...
          :key="product.id"
        >
          <Cardproductfullbody :product="product" />
        </div>
      </div>
    </div>
...
import Cardproductfullbody from '@/components/Cardproductfullbody.vue';
...
export default {
  ...
  methods: {
    ...
    searchProduct() {
      axios
        .get(
          "https://my-json-server.typicode.com/anggitaputra13/Hera-Spa/fullbody-massage?q=" +
            this.search
        )
  ...
  mounted() {
    axios
      .get(
        "https://my-json-server.typicode.com/anggitaputra13/Hera-Spa/fullbody-massage"
      )
      .then((response) => this.setProduct(response.data))
      .catch((error) => console.log(error));
  },

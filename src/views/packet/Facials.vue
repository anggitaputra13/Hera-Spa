    ...
    <div class="container">
      ...
      <div class="row mb-4">
        <div
          ...
          :key="product.id"
        >
          <Cardproductfacials :product="product" />
        </div>
      </div>
    </div>
...
import Cardproductfacials from "@/components/Cardproductfacials.vue";
...
export default {
  ...
  methods: {
    ...
    searchProduct() {
      axios
        .get(
          "https://my-json-server.typicode.com/anggitaputra13/Hera-Spa/facials?q=" +
            this.search
        )

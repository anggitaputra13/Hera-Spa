    ...
    <div class="container">
      ...
      <div class="row mb-4">
        <div
          ...
          :key="product.id"
        >
          <Cardproductnails :product="product" />
        </div>
      </div>
    </div>
...
import Cardproductnails from "@/components/Cardproductnails.vue";
...
export default {
  ...
  methods: {
    ...
    searchProduct() {
      axios
        .get(
          "https://my-json-server.typicode.com/anggitaputra13/Hera-Spa/nails?q=" +
            this.search
        )
  ...
  mounted() {
    axios
      .get("https://my-json-server.typicode.com/anggitaputra13/Hera-Spa/nails")
      .then((response) => this.setProduct(response.data))
      .catch((error) => console.log(error));
  },
};
